...
def sample_timesheets():
    ...
    return [
        {"consultant": "John Doe", "project": "ACM-101", "hours": 8.0, "date": "2026-02-10"},
        {"consultant": "Jane Smith", "project": "BET-5", "hours": 7.5, "date": "2026-02-11"},
        {"consultant": "John Doe", "project": "ACM-101", "hours": 6.0, "date": "2026-02-12"}
    ]
...
class TestCSVOperations:
    ...
    def test_hours_conversion(self, temp_dir):
        ...
        data = [{"consultant": "John", "project": "ACM", "hours": 8.5, "date": "2026-02-10"}]
...
class TestAppendToCSV:
    ...
    def test_append_to_existing_file(self, temp_dir):
        ...
        # Create initial file
        initial = [{"consultant": "John", "project": "ACM-101", "hours": 8.0, "date": "2026-02-10"}]
        write_timesheets_to_csv(initial, str(filepath))
        
        # Append new entry
        new_entry = {"consultant": "Jane", "project": "BET-5", "hours": 7.0, "date": "2026-02-11"}
    ...
    def test_append_creates_new_file(self, temp_dir):
        ...
        entry = {"consultant": "John", "project": "ACM-101", "hours": 8.0, "date": "2026-02-10"}
    ...
    def test_multiple_appends(self, temp_dir):
        ...
        for i in range(3):
            entry = {"consultant": f"Person{i}", "project": "ACM", "hours": 8.0, "date": "2026-02-10"}
            append_timesheet_to_csv(entry, str(filepath))
...
class TestMergeJSONFiles:
    ...
    def test_merge_skips_nonexistent(self, temp_dir):
        ...
        count = merge_json_files(
            [str(file1), "nonexistent.json"],
            str(output)
        )
