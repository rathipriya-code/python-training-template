...
def get_total_hours_by_consultant(
    timesheets: List[Dict[str, Any]], consultant: str
) -> float:
    """
...
def get_entries_by_date_range(
    timesheets: List[Dict[str, Any]], start_date: str, end_date: str
) -> List[Dict[str, Any]]:
    """
...
def update_project_code(
    timesheets: List[Dict[str, Any]], old_code: str, new_code: str
) -> List[Dict[str, Any]]:
    """
