...
class TestDatabaseClass:
    ...
    def test_create_and_get_consultant(self, tmp_path):
        ...
        db = Database(str(tmp_path))
        consultant = {"name": "John Doe", "email": "john@example.com", "hourly_rate": 75.0}
    ...
    def test_update_consultant(self, tmp_path):
        ...
        updated_data = {"name": "Jane Smith", "email": "jane@example.com", "hourly_rate": 85.0}
...
class TestAdvancedEndpoints:
    ...
    def test_consultant_timesheets(self):
        ...
        # Create consultant
        consultant = client.post("/consultants", json={
            "name": "Test User",
...
class TestTimesheetReporting:
    ...
    def test_report_with_date_filter(self):
        ...
        response = client.get("/timesheets/report?start_date=2026-02-01&end_date=2026-02-28")
        assert response.status_code == 200
