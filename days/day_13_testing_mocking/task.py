...
class ConsultantService:
    ...
    async def update_consultant_rate(
        self, consultant_id: int, employee_id: str
    ) -> Dict:
        """
...
class InvoiceService:
    ...
    async def generate_invoice_for_period(
        self, consultant_id: int, start_date: date, end_date: date, timesheets: list
    ) -> Dict:
        """
...
async def batch_validate_employees(
    employee_ids: list, hr_system: ExternalHRSystem
) -> Dict[str, bool]:
    """
