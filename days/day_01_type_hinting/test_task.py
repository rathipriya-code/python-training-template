...
class TestFormatConsultantName:
    ...
    def test_with_title(self):
        ...
        assert format_consultant_name("Jane", "Smith", include_title=True) == "Consultant Jane Smith"
    ...
    def test_hyphenated_names(self):
        ...
        assert format_consultant_name("Mary-Jane", "Watson-Parker") == "Mary-Jane Watson-Parker"
