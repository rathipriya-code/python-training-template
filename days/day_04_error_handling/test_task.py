...
class TestValidateHours:
    ...
    def test_negative_hours(self):
        ...
        with pytest.raises(
            InvalidHoursError, match="Hours must be between 0.5 and 24.0"
        ):
            validate_hours(-5.0)
...
class TestValidateAndCreateEntry:
    ...
    def test_empty_consultant(self):
        ...
        with pytest.raises(
            TimesheetValidationError, match="Consultant name cannot be empty"
        ):
    ...
    def test_empty_project(self):
        ...
        with pytest.raises(
            TimesheetValidationError, match="Project code cannot be empty"
        ):
...
class TestSafeGetNestedValue:
    ...
    def test_missing_nested_key(self):
        ...
        assert (
            safe_get_nested_value(data, "consultant", "email", default="N/A") == "N/A"
        )
